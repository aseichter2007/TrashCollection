...
namespace TrashCollection.Controllers
{
    ...
    public class CustomersController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Customers.Include(c => c.Address).Include(c => c.IdentityUser).Include(c => c.Weekday);
        ...
        public IActionResult Create()
        {
            ...
            ViewData["DayId"] = new SelectList(_context.Weekdays, "Id", "Id");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,IdentityUserId,AddressId,DayId,FirstName,LastName,SuspendStert,SuspendEnd")] Customer customer)
        {
